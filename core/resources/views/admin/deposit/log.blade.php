...
@section('panel')
    <div class="row justify-content-center">
        @if (request()->routeIs('admin.payment.list') || request()->routeIs('admin.payment.method') || request()->routeIs('admin.users.deposits') || request()->routeIs('admin.users.deposits.method'))
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 b-radius--5 bg--success has-link">
                    <a class="item-link" href="{{ route('admin.payment.successful') }}"></a>
            ...
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 b-radius--5 bg--6 has-link">
                    <a class="item-link" href="{{ route('admin.payment.pending') }}"></a>
                    <div class="widget-two__content">
            ...
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 has-link b-radius--5 bg--pink">
                    <a class="item-link" href="{{ route('admin.payment.rejected') }}"></a>
                    <div class="widget-two__content">
            ...
            <div class="col-xxl-3 col-sm-6 mb-30">
                <div class="widget-two box--shadow2 has-link b-radius--5 bg--dark">
                    <a class="item-link" href="{{ route('admin.payment.initiated') }}"></a>
                    <div class="widget-two__content">
                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-outline--primary ms-1" href="{{ route('admin.payment.details', $deposit->id) }}">
