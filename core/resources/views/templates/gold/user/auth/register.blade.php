...
@section('panel')
    <section class="account bg-img"
        data-background-image="{{ getImage('assets/images/frontend/register/' . @$content->data_values->image, '1235x980') }}">
        <div class="container">
                    ...
                    <div class="account-form">
                        ...
                        <form class="verify-gcaptcha" action="{{ route('user.register') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative">
                                            <input class="form--control checkUser" id="Username" name="username"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="select-phone">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control form--control checkUser ps-0" name="mobile"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative">
                                            <input
                                                ...
                                                id="your-password" name="password" type="password" required>
                                            <span class="input-icon"><span class="icon-Lock"></span></span>
                                            <span class="password-show-hide icon-eye toggle-password icon-eye-off"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input class="form--control" name="referBy" type="text"
                                                    value="{{ session()->get('reference') }}" required>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form--check">
                                                <input class="form-check-input" id="remember" name="agree"
                                                ...
                                                <div class="form-check-label">
                                                    ...
                                                    @foreach ($policyPages as $policy)
                                                        <a class="text--base"
                                                            ...
                                                            target="_blank">@lang($policy->data_values->title) </a>
                                                        @if (!$loop->last)
                                                            ,
                                                        @endif
                                                    @endforeach
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <button class="btn btn-outline--base w-100" type="submit"> <span
                                                class="text--gradient">@lang('Submit')</span> </button>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="have-account text-center">
                                        <p class="have-account__text">@lang('Already Have An Account')? <a
                                                class="have-account__link text--gradient fw-bold"
    ...
    <div class="modal fade custom--modal" id="existModalCenter" role="dialog" aria-labelledby="existModalCenterTitle"
